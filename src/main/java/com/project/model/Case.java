...
public class Case {
    ...
    public Case(String title, String description, SeverityLevel severity, String relatedInfo) {
        this(null, title, description, relatedInfo, severity, CaseState.CASE_CREATED, null, null, null);
    }

    public Case(Integer caseId, String title, String description, String relatedInfo, SeverityLevel severity,
                CaseState status, Integer createdByUserId, Integer assignedOfficerId, LocalDateTime createdAt) {
        this.caseId = caseId;
        this.title = title;
